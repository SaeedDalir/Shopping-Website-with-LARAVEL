...
{{--            <!-- Banner End-->--}}
                    ...
                    <div class="owl-carousel product_carousel_tab">
                        @foreach($latestProducts as $product)
                            <div class="product-thumb clearfix">
                                <div class="image"><a href="product.html"><img src="{{$product->photos[0]->path}}" alt="{{$product->title}}" title="{{$product->title}}" class="img-responsive" /></a></div>
                                <div class="caption">
            ...
            <div id="carousel" class="owl-carousel nxt">
                @foreach($brands as $brand)
                    <div class="item text-center"> <a href="#"><img src="{{$brand->photo->path}}" alt="{{$brand->title}}" class="img-responsive" /></a> </div>
                @endforeach
