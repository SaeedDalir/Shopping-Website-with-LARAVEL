                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">نام کاربری مدیر</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('categories.index')}}"><i class="fa fa-list"></i>لیست دسته بندی ها </a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('attributes-group.index')}}"><i class="fa fa-list"></i>لیست ویژگی ها </a></li>
                    </ul>
                    <ul class="treeview-menu">
                        <li><a href="{{route('attributes-value.index')}}"><i class="fa fa-list"></i>لیست مقادیر ویژگی ها </a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
